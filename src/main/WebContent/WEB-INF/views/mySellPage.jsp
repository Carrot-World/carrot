...
<link
	href="${pageContext.request.contextPath}/resources/html/mypage/style(sell).css"
	rel="stylesheet" />
<script
	...
	<div class="header bg-body-tertiary">
		<nav class="navbar">
			<a class="navbar-brand logo" href="#"> <img
				...
				width="40" height="35" class="align-text-top" /> 당근나라
			</a>
		...
		<div class="section-header">
			<div class="user-info-wrapper">
				...
				<div class="button-wrapper">
					<button class="btn update" data-bs-target="#updateModal" data-bs-toggle="modal">내정보수정</button>
				</div>
			</div>
		</div>
