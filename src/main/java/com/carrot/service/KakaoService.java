...
public class KakaoService {
        ...
        public String getAccessToken (String authorize_code) {
            ...
            try {
                ...
                sb.append("&client_id=f79a580a7852275495f6384ff13085b4");  //본인이 발급받은 key : rest api
                sb.append("&redirect_uri=http://localhost:8080/api/signup/callback/kakao");     // 본인이 설정해 놓은 경로
